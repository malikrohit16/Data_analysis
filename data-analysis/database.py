...
# Our database class objects are going to inherit from this class ClassName(object):
...
hashtag_tweet = Table('hashtag_tweet', Base.metadata,
    Column('hashtag_id', Integer, ForeignKey('hashtags_id'), nullable=False),
    Column('tweet_id', Integer, ForeignKey('tweets_id'), nullable=False))
